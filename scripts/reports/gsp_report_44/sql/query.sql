...
FROM
    (
        ...
        FROM
            ...
            LEFT JOIN
                o2pprod.RestInterface_user AMUSR
                ON
                    USRBRN.user_id = AMUSR.id
        WHERE
    ...
    LEFT JOIN
        (
            ...
            WHERE
                DATE(OrderTakenDate) BETWEEN '2023-03-01' AND '2023-03-31'
            GROUP BY
                WorkOrderNo
              , OrderTakenDate
              , OrderTakenBy
        ...
        STP
        ON
            STP.WorkOrderNo = O2P.order_code
LIMIT 1 \G
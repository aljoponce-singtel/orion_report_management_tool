...
class IlcTransport(Base):
    __tablename__ = 't_GSP_ip_ilc_transport'
    ...
    PreConfig_Team = Column(String(10))
    ...
    Coordination_Team = Column(String(10))
    ...
    def __repr__(self):
        return "<IlcTransport(OrderCode='%s', update_time='%s')>" % (self.OrderCode, self.update_time)
